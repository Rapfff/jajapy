...
def modelMGOHMM():
	s0 = MGOHMM_state([(0,0.9),(1,0.1)],[[3.0,5.0],[2.0,4.0]],0)
	s1 = MGOHMM_state([(0,0.05),(1,0.9),(2,0.04),(4,0.01)],[[0.5,1.5],[2.5,1.5]],1)
	s2 = MGOHMM_state([(1,0.05),(2,0.8),(3,0.14),(4,0.01)],[[0.2,0.7],[1.0,1.0]],2)
	s3 = MGOHMM_state([(2,0.05),(3,0.95)],[[0.0,0.3],[1.5,5.0]],3)
	s4 = MGOHMM_state([(1,0.1),(4,0.9)],[[2.0,4.0],[0.5,0.5]],4)
	return MGOHMM([s0,s1,s2,s3,s4],[0.1,0.7,0.0,0.0,0.2],name="MGOHMM")
