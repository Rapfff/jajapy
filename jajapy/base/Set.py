...
class Set:
	...
	def __init__(self, sequences:list, times:list = None, t: int = None) -> None:
		...
		sequences : list
			...
			- a sequence of vectors of timed observations (list of list of float) ->GoHMM
		...
		if t != None:
			...
			if (type(sequences[0][1])  == float64 or type(sequences[0][1])  == float) and type(sequences[0][0])  == str:
